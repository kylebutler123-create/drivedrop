...
function CustomerSummaryActivity({count}:{count:number}){
 ...
 return <span className="customerSummaryActivity"><i aria-hidden="true"/>{count} new {count===1?'update':'updates'}</span>;
}
