   ...
   try{
    ...
    cards.forEach(card=>{
      ...
      button.addEventListener('click',async()=>{
        ...
        if(!reason)return;
        if(!window.confirm('Cancel this delivery? The customer payment will be automatically refunded, the request will reopen for new quotes, and a £50 cancellation fine will be deducted from your next completed job payout.'))return;
