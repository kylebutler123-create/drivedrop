...
export default function TransporterDeliveredSummary(){
 ...
 useEffect(()=>{
  setTarget(null);setListTarget(null);setShow(false);setExpanded(null);setLoaded(false);setLoadFailed(false);setRefreshing(false);if(pathname!=='/transporter')return;
