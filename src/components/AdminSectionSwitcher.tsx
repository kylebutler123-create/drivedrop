...
export default function AdminSectionSwitcher({userCount,transporterCount,pendingVerificationCount,disputeCount,openDisputeCount,readyPayoutCount,blockedPayoutCount,userSection,verificationSection,disputeSection,operationsSection,initialView='ALL',actionLabel}:{userCount:number;transporterCount:number;pendingVerificationCount:number;disputeCount:number;openDisputeCount:number;readyPayoutCount:number;blockedPayoutCount:number;userSection:ReactNode;verificationSection:ReactNode;disputeSection:ReactNode;operationsSection:ReactNode;initialView?:View;actionLabel?:string}){
