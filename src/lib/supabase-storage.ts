...
export function validateVerificationFile(file:File){return validate(file,verificationTypes,MAX_VERIFICATION_FILE_SIZE,'PDF, JPG/JPEG and PNG')}
...
export function validateEvidenceFile(file:File){return validate(file,evidenceTypes,MAX_EVIDENCE_FILE_SIZE,'JPG/JPEG, PNG and WebP image')}
